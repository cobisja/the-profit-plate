 ...
 */
final class Version20240401015529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredients ADD cost NUMERIC(8, 2) UNSIGNED DEFAULT \'0\' NOT NULL, CHANGE quantity quantity NUMERIC(8, 2) UNSIGNED DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredients DROP cost, CHANGE quantity quantity NUMERIC(8, 2) UNSIGNED DEFAULT \'0.00\' NOT NULL');
